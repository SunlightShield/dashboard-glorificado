    ...
    series: [
      {
        ...
        label: { show: false },
        data: [
          { value: completed, name: 'Completadas', itemStyle: { color: '#34d399' } },
          { value: pending, name: 'Pendientes', itemStyle: { color: '#fbbf24' } },
      ...
      {failedCount > 0 && (
        <div className="flex flex-col gap-4">
          <button
            ...
            className="self-start bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 hover:border-red-500/50 text-red-400 text-xs font-mono uppercase tracking-widest px-4 py-2 rounded-lg transition-colors cursor-pointer"
          >
            {showDrillDown ? '✕ Ocultar errores' : `⚠ Ver detalle de errores (${failedCount})`}
          </button>
